...
export function BoxFile({
  ...
  return (
    ...
    >
      <div className="block">
        <HoverPreviewCard project={project} visible={isHovered} />
      </div>
      <motion.div
    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="absolute bottom-full left-1/2 -translate-x-1/2 -translate-y-3 z-20 pointer-events-none w-[min(340px,86vw)] max-w-[340px]"
        >
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-20">
          ...
          <Parallax speed="fast" className="md:shrink-0">
            <div className="flex items-center gap-3 font-mono text-[10px] uppercase tracking-[0.25em] text-[#5A5A5A] whitespace-nowrap">
