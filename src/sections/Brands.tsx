      ...
      >
        <div className="flex gap-16 whitespace-nowrap animate-marquee will-change-transform">
          {row.map((brand, i) => (
            <span
              key={`${brand}-${i}`}
              className="font-display text-4xl md:text-6xl font-medium text-[#5A5A5A] hover:text-[#F5F5F5] transition-colors duration-500 tracking-tight flex items-center gap-16"
            >
              {brand}
