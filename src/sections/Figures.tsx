...
const figures = [
  ...
  },
  {
    ...
    label: 'CSAT Score',
    description:
      'Average customer satisfaction across shipped work — measured through post-launch surveys and stakeholder feedback.',
  },
]
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 md:divide-x md:divide-[#242424] border-t border-b border-[#242424]">
          {figures.map((f, i) => (
            <div
              key={f.label}
